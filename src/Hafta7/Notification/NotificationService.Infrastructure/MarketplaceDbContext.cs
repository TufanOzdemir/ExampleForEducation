    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasMany(u => u.Permissions)
                ...
                "UserPermission", // Ara tablonun ad�
                j => j
                    .HasOne<Permission>()
                    .WithMany()
                    .HasForeignKey("PermissionId") // Senin veritaban�ndaki kolon ad�
                    .HasPrincipalKey(p => p.Id),
                j => j
                    .HasOne<User>()
                    .WithMany()
                    .HasForeignKey("UserId") // Senin veritaban�ndaki kolon ad�
                    .HasPrincipalKey(u => u.Id),
                j =>
                {
                    j.HasKey("UserId", "PermissionId"); // Composite Key tan�m�
                });
        });
